...
class OdooModuleVersionRuleInfoReport(models.Model):
    ...
    analysis_rule_id = fields.Many2one(
        string="Analysis Rule id", comodel_name="github.analysis.rule",
    )
    ...
    module_version_id = fields.Many2one(
        string="Module Version", comodel_name="odoo.module.version",
    )
    ...
    def init(self):
        ...
        self._cr.execute(
            ...
            CREATE OR REPLACE VIEW odoo_module_version_rule_info_report AS (
                ...
                ON omvri.repository_branch_id = grb.repository_branch_id
